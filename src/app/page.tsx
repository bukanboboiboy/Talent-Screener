  ...
  return (
    <div {...getRootProps()} className={`min-h-screen transition-colors ${isDragActive ? 'bg-blue-50 dark:bg-blue-900/20' : ''}`}>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        ...
        <div className="border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-colors text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20" onClick={() => (document.querySelector('input[type="file"]') as HTMLInputElement)?.click()}>
